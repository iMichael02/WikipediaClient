...
public class MainActivity extends AppCompatActivity {
    ...
    private BottomNavigationView mBottomNavigationViewNotLoggedIn;
    private BottomNavigationView mBottomNavigationViewLoggedIn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(currentUser!=null) {
            mBottomNavigationView = findViewById(R.id.bottom_navigation_loggedIn);
            mBottomNavigationViewNotLoggedIn = findViewById(R.id.bottom_navigation);
            mBottomNavigationView.setVisibility(View.VISIBLE);
            mBottomNavigationViewNotLoggedIn.setVisibility(View.GONE);
            userEmail = findViewById(R.id.userEmailNavMain);
                ...
                public void onPageSelected(int position) {
                    ...
                    switch (position) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            mBottomNavigationView.getMenu().findItem(R.id.menu_saved).setChecked(true);
                            break;
                    }
                }
            });
            ...
            mBottomNavigationViewLoggedIn = findViewById(R.id.bottom_navigation_loggedIn);
            mBottomNavigationView.setVisibility(View.VISIBLE);
            mBottomNavigationViewLoggedIn.setVisibility(View.GONE);
            ViewPagerAdapter adapter = new ViewPagerAdapter(this);
            mViewPager2.setAdapter(adapter);
            mViewPager2.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
                @Override
